...
class KmerAnnotationByFigfam(object):
    ...
    def get_dataset_names(self):
        resp = self._call('KmerAnnotationByFigfam.get_dataset_names',
                          [])
        return resp[0]

    def get_default_dataset_name(self):
        resp = self._call('KmerAnnotationByFigfam.get_default_dataset_name',
                          [])
        return resp[0]

    def annotate_proteins(self, proteins, params):
        resp = self._call('KmerAnnotationByFigfam.annotate_proteins',
                          [proteins, params])
        return resp[0]

    def annotate_proteins_fasta(self, protein_fasta, params):
        resp = self._call('KmerAnnotationByFigfam.annotate_proteins_fasta',
                          [protein_fasta, params])
        return resp[0]

    def call_genes_in_dna(self, dna, params):
        resp = self._call('KmerAnnotationByFigfam.call_genes_in_dna',
                          [dna, params])
        return resp[0]

    def estimate_closest_genomes(self, proteins, dataset_name):
        resp = self._call('KmerAnnotationByFigfam.estimate_closest_genomes',
