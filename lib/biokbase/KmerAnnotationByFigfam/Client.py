...
class KmerAnnotationByFigfam(object):
    ...
    def get_dataset_names(self):
        ...
        arg_hash = {'method': 'KmerAnnotationByFigfam.get_dataset_names',
                    'params': [],
                    'version': '1.1',
    ...
    def get_default_dataset_name(self):
        ...
        arg_hash = {'method': 'KmerAnnotationByFigfam.get_default_dataset_name',
                    'params': [],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def annotate_proteins(self, proteins, params):

        arg_hash = {'method': 'KmerAnnotationByFigfam.annotate_proteins',
                    'params': [proteins, params],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def annotate_proteins_fasta(self, protein_fasta, params):

        arg_hash = {'method': 'KmerAnnotationByFigfam.annotate_proteins_fasta',
                    'params': [protein_fasta, params],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def call_genes_in_dna(self, dna, params):

        arg_hash = {'method': 'KmerAnnotationByFigfam.call_genes_in_dna',
                    'params': [dna, params],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def estimate_closest_genomes(self, proteins, dataset_name):

        arg_hash = {'method': 'KmerAnnotationByFigfam.estimate_closest_genomes',
                    'params': [proteins, dataset_name],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
